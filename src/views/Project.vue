      ...
      <v-container>
        <v-layout wrap>
          ...
          <v-flex xs12 sm10 offset-sm1>
            <!-- project description -->
            <v-layout row style="padding: 2vw 0vw;">
...
export default {
  ...
  methods: {
    ...
    async like_project() {
      if (this.user) {
        var result = await FirebaseService.like_project(this.user, this.project_id, this.project.likeit, this.project.likeitcount)
