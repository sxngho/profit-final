        ...
        <v-simple-table dense>
          ...
          <tbody class="text-center">
            ...
            <tr v-if="!togglePay">
              <td> 급여 </td>
              <td>
                <input class="chatinput" type="number" v-model="inputPay"  v-on:keyup.esc="cancelPay()" ref="PayRef"  v-on:keyup.enter="completePay(inputPay)" style="-moz-appearance:textfield;"/>
            ...
            <tr v-if="!toggleDownPayment">
              <td> 계약금 </td>
              <td>
                <input class="chatinput" type="number" v-model="inputDownPayment" v-on:keyup.esc="cancelDownPayment()" ref="DownPaymentRef" v-on:keyup.enter="completeDownPayment(inputDownPayment)" />
            ...
            <tr v-if="!togglePenalty" >
              <td> 위약금 </td>
              <td>
                <input class="chatinput" type="number"  v-model="inputPenalty" v-on:keyup.esc="cancelPenalty()" ref="PenaltyRef" v-on:keyup.enter="completePenalty(inputPenalty)"/>
            ...
            <tr v-if="!toggleCompany">
              <td> 책임자 </td>
              <td>
                <input class="chatinput" type="text"  v-model="inputCompany" ref="CompanyRef" v-on:keyup.esc="cancelCompany()" v-on:keyup.enter="completeCompany(inputCompany)"/>
            ...
            <tr v-if="!togglePhonenumber">
              <td> 핸드폰번호 </td>
              <td>
                <input class="chatinput" type="text" v-model="inputPhonenumber" ref="PhonenumberRef" v-on:keyup.esc="cancelPhonenumber()" v-on:keyup.enter="completePhonenumber(inputPhonenumber)" />
